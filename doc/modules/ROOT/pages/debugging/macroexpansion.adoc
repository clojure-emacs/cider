...
you'll expand that call. Here the cursor is sitting on the bare symbol
`+when+`, and the expansion is of the whole `+when+` form rather than of the
symbol:

image::cider-macroexpand-at-point.gif[Expanding the call around the cursor from a bare symbol]
