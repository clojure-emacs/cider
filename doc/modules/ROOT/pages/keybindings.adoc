...
| `cider-eval-form`
| Evaluate the form point indicates and show the result in the echo area.
...
| Evaluate the form point indicates and replace it with the result.

| kbd:[C-c M-e]
| `cider-eval-form-to-repl`
| Evaluate the form point indicates and send the result to the REPL.

| kbd:[C-c C-p]
| `cider-pprint-eval-form`
| Evaluate the form point indicates and pretty-print the result in a popup.
...
| Copy the form point indicates into the REPL prompt.
