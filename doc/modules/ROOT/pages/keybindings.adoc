...
TIP: If you pause after the kbd:[C-c C-x] prefix, a menu pops up listing every way
to start or connect to a session. See xref:basics/up_and_running.adoc[Up and Running].
