...
```clj
 :dependencies [[cider/cider-nrepl "0.38.1"] ;; mandatory (unless it's inherited from deps.edn or otherwise present in the classpath of shadow-cljs's JVM process)
