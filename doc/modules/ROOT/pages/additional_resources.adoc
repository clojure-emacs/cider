...
A single-page xref:attachment$cider-refcard.pdf[quick reference PDF] for CIDER
commands ships with this manual. It is generated from
https://github.com/clojure-emacs/cider/blob/master/refcard/cider-refcard.tex[the CIDER refcard LaTeX file].
...
IMPORTANT: Keep in mind that third-party tutorials might be outdated by the time you get to read them.
