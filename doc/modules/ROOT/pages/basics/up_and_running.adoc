...
this looks for `tools.deps`:
  ...
  $ clojure -Sdeps '{:deps {nrepl {:mvn/version "1.3.1"} cider/cider-nrepl {:mvn/version "0.53.1"}}}' -m nrepl.cmdline --middleware '["cider.nrepl/cider-middleware"]'
...
[source,sh]
----
$ clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.53.1"}}}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
