...
ssh -t -L 12345:localhost:12345 MY_REMOTE_SERVER \
    ...
    "clojure -Sdeps '{:deps {nrepl/nrepl {:mvn/version \"1.5.1\"} cider/cider-nrepl {:mvn/version \"0.58.0\"}}}' -m nrepl.cmdline -p 12345 -b 0.0.0.0 --middleware '[\"cider.nrepl/cider-middleware\"]' "
----
