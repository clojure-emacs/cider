...
this looks for `tools.deps`:
  ...
  $ clojure -Sdeps '{:deps {nrepl {:mvn/version "1.2.0"} cider/cider-nrepl {:mvn/version "0.49.3"}}}' -m nrepl.cmdline --middleware '["cider.nrepl/cider-middleware"]'
...
[source,sh]
----
$ clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.49.3"}}}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
