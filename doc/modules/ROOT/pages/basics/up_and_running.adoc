...
this looks for `tools.deps`:
  ...
  $ clojure -Sdeps '{:deps {nrepl {:mvn/version "0.6.0"} cider/cider-nrepl {:mvn/version "0.37.1"}}}' -m nrepl.cmdline --middleware '["cider.nrepl/cider-middleware"]'
...
[source,sh]
----
$ clj -Sdeps '{:deps {cider/cider-nrepl {:mvn/version "0.37.1"}}}' -m nrepl.cmdline --middleware "[cider.nrepl/cider-middleware]"
----
