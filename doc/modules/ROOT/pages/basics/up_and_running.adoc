...
kbd:[RET]. CIDER will start an nREPL server and automatically
connect to it.

NOTE: If your project uses `lein`, `boot` or `tools.deps (deps.edn)`,
...
Alternatively, you can use kbd:[C-u M-x] `cider-jack-in` kbd:[RET] to
