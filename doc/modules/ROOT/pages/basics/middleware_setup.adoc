...
----
  :cider-clj {:extra-deps {cider/cider-nrepl {:mvn/version "0.37.0"}
              ...
              ;; you may remove `,refactor-nrepl.middleware/wrap-refactor`:
  ...
  :cider-cljs {:extra-deps {org.clojure/clojurescript {:mvn/version "1.10.339"}
                            ...
                            refactor-nrepl/refactor-nrepl {:mvn/version "3.9.0"} ;; optional
                            cider/piggieback {:mvn/version "0.5.3"}}
               :main-opts ["-m" "nrepl.cmdline" "--middleware"
                           ;; you may remove `,refactor-nrepl.middleware/wrap-refactor`:
                           "[cider.nrepl/cider-middleware,refactor-nrepl.middleware/wrap-refactor,cider.piggieback/wrap-cljs-repl]"]}
----
