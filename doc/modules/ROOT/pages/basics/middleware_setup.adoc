...
[source,clojure]
----
{:repl {:plugins [[cider/cider-nrepl "0.46.0"]]}}
----
...
(swap! boot.repl/*default-dependencies*
       concat '[[cider/cider-nrepl "0.46.0"]])
...
[source,clojure]
----
  :cider-clj {:extra-deps {cider/cider-nrepl {:mvn/version "0.46.0"}}
...
dependencies {
  ...
  devImplementation 'cider:cider-nrepl:0.46.0'
}
