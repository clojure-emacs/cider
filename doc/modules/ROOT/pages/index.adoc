...
* Follow the xref:basics/quickstart.adoc[Quick Start] to xref:basics/installation.adoc[install] CIDER and get it xref:basics/up_and_running.adoc[up and running]
