...
(ert-deftest cider-inject-jack-in-dependencies-add-refactor-nrepl ()
  (let ((cider-jack-in-lein-plugins (seq-concatenate 'list cider-jack-in-lein-plugins '(("refactor-nrepl" "2.0.0"))))
        (cider-jack-in-nrepl-middlewares (seq-concatenate 'list cider-jack-in-nrepl-middlewares '("refactor-nrepl.middleware/wrap-refactor"))))
    (should (string= (cider-inject-jack-in-dependencies "repl :headless" "lein")
