...
(defvar cider-tips
  '(;; Connection / session
    ...
    ;; Eval
    "Press <\\[cider-eval-defun]> to eval the top-level form at point."
    ...
    "Press <\\[cider-pprint-eval-form]> to evaluate the preceding form and pretty-print the result."
    "Press <\\[cider-pprint-eval-defun]> to evaluate the top-level form at point and pretty-print the result."
    ...
    "Press <\\[cider-inspect-defun]> to inspect the result of the top-level form at point."
    "Press <\\[cider-debug-defun]> to instrument the top-level form and step through it interactively in the debugger."
    ;; Xref
